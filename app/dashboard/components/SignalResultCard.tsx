        ...
        <div className="flex flex-wrap gap-1.5 sm:gap-2 pt-1">
          ...
          {showGenerateNext && onGenerateNext && (
            <button
              ...
              style={{ background: 'linear-gradient(135deg, var(--accent-gold), rgb(var(--accent-gold-hover-rgb)))', color: '#ffffff', border: '1px solid rgb(var(--accent-gold-rgb))' }}
            >
              {generatingNext ? (
          ...
          {!showGenerateNext && confirmed && onWon && (
            <button
              ...
              disabled={outcomeUpdating}
              className="flex-1 py-2.5 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-all hover:opacity-90 disabled:opacity-50"
              style={{ background: 'rgb(var(--status-win-rgb))', color: '#ffffff', border: '1px solid rgb(var(--status-win-rgb))' }}
            >
              {outcomeUpdating ? <Loader2 className="w-3.5 h-3.5 animate-spin" /> : <CheckCircle className="w-3.5 h-3.5" />}
              Won
            </button>
          ...
          {!showGenerateNext && confirmed && onLost && (
            <button
              ...
              disabled={outcomeUpdating}
              className="flex-1 py-2.5 rounded-lg text-xs font-bold flex items-center justify-center gap-1.5 transition-all hover:opacity-90 disabled:opacity-50"
              style={{ background: 'rgb(var(--status-loss-rgb))', color: '#ffffff', border: '1px solid rgb(var(--status-loss-rgb))' }}
            >
